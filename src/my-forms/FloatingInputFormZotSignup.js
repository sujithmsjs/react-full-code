...
const FloatingInputFormZotSignup = () => {
  ...
  return (
    <>
      ...
      <h3>Floating Inputs Form With ZOD Signup</h3>
      <form onSubmit={handleSubmit(onSubmit)} noValidate>
        ...
        <MySubmitButton label='Signup' formState={formState} />
...
export default FloatingInputFormZotSignup;
